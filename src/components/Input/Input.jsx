...
const Input = ({ id, placeholder, onChange, value, title, name }) => {
  return (
    <div>
      <label className='text-Neutral60 text-Small/Label/Small md:text-Medium+/Label/Small  text-sm' htmlFor={id}>{title}</label>
      <input
        type="text"
        id={id}
        name={name}
