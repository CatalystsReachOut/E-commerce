...
const ItemCard = ({ onClick, addQuantity, removeQuantity, item, added, cart }) => {
    ...
    return (
        <div className='w-[100%] p-[16px] rounded-[8px] bg-Neutral10 flex flex-col'>
            ...
            <div className='description'>
                <div>
                    <div className="text-Medium+/Label/Large-Strong text-Neutral80 mt-[16px]">
                        {item?.name}
                    </div>
                    <div className='text-Neutral60 text-Medium+/Label/Medium mt-[4px]'>
                        {item?.quantity}
                    </div>
                </div>

                <div className='mt-[16px]'>
                    <span className='text-Medium+/Label/Medium text-Neutral80'>₹</span> <span className='text-Neutral80 text-Medium+/Title/Small'>{item?.price}</span>
                </div>
                ...
                <div className='mt-[16px]'>
                    {
                        added ?
                            <>
                                ...
                                <div className='flex  gap-4 text-base'>
                                    ...
                                    <div className='w-[100%]  flex items-center justify-center border border-[#228B22]  rounded'>
                                        <div className="absolute h-[20px] w-[20px] bg-Primary80 flex items-center justify-center rounded-full Medium+/Paragraph/xSmall-Strong text-Neutral10  text-sm translate-x-[10px] -translate-y-[5px]">{cart.find(data => data.id == item.id).count}</div>
                                        <img src={Bag} alt="" />
                                    </div>
                                    <div
                            ...
                            : <button onClick={onClick} className={`border-[2px] border-Primary60  text-Primary60 text-Medium+/Label/Large-Strong p-[16px] w-[100%] rounded-[8px] flex justify-center gap-[10px] items-center add_bag`}>
