        ...
        <div className="container flex justify-between items-center h-full">
            <div className=''>
                ...
                <div className='flex gap-5 max-h-[40px]'>
                    <ButtonGradient title={'View Bag & Continue'} className={'max-h-[50px] min-w-[250px]'}/>
                    <ButtonOutline title={'Keep Shopping'} color={'#FFFFFF'} className={'max-h-[50px] max-w-[200px] text-[#FFFFFF]'}/>
                </div>
            </div>
