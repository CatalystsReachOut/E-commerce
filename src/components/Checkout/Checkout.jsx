...
const Checkout = ({isOpen, onOpen, onClose}) => {
    ...
    return (
        <>
            ...
            <Modal isOpen={isOpen} className='' blockScrollOnMount={false} scrollBehavior={'scroll'} onClose={onClose}>
                <ModalOverlay className='opacity-50 bg-[#F4F9F4]' />
                {
                    step == 1
                        ?
                        <ModalContent className='bg-[#FFFFFF] p-8 shadow sm:max-w-[80vw] max-w-[95vw] h-full m-auto sm:my-auto mt-4 '>
                            ...
                            <ModalFooter className='mt-3 '>
                                <div className='w-full flex sm:flex-row gap-3 flex-col justify-between'>
                                    ...
                                    <button className='sm:px-6 px-2 py-2.5 rounded-lg sm:text-base text-sm flex justify-center items-center bg-[#F4F9F4] text-[#3C3C3C]' onClick={onClose}>
                                        You can order now & pay directly on delivery
                                    </button>
                                    <ButtonGradient onClick={() => { setStep(2) }} title={'Add Shipping Details'} className={'sm:px-6 px-2 sm:text-base text-sm'} />
                                </div>
                            </ModalFooter>
                        </ModalContent>
                        :
                                            ...
                                            <div className="col-span-1">
                                                <div>
                                                    ...
                                                    <div className="grid grid-cols-8 gap-3">
                                                        <input
                                                            type="text"
                                                            className='sm:col-span-1 col-span-3 h-[45px] text-lg mt-1 px-2 py-1 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-[#228B22] focus:ring-[#228B22] block w-full rounded-md sm:text-sm focus:ring-1'
                                                            defaultValue={'+91'}
                                                        />
                                                        <input
                                                            type="text"
                                                            className='sm:col-span-7 col-span-5 h-[45px] sm:text-lg mt-1 sm:px-2 px-1 py-1 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-[#228B22] focus:ring-[#228B22] block w-full rounded-md sm:text-sm focus:ring-1'
                                                        />
                        ...
                        <ModalContent className='bg-[#FFFFFF] p-8 shadow sm:max-w-[80vw] max-w-[95vw] m-auto my-auto mt-4'>
                            ...
                            <ModalBody>
                                <div className='mt-3'>
                                    <div className="sm:grid flex flex-wrap-reverse gap-5 grid-cols-2">
